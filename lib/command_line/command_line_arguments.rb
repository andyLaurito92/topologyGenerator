...
class CommandLineArguments
    ...
    def run
        ...
        my_command = command :source do |c|
          ...
          c.example 'Retrieve network from ONOS controller, and serialize it as a DEVS model', 'Topologygenerator source -p network_providers/onos_topology_provider -s network_serializers/powerdevs_serializer -o output_directory -u http://127.0.0.1:8181/onos/v1/'
